...
#define	LEX_LITERAL_NUMO 'q'    // шестнадцатеричный литерал
//#define	LEX_LITERAL_BINARY 'b'  
...
#define LEX_GOUTLAW		 'g'	// объявления переменных
#define LEX_MORE		 '>'	// проверка на больше
#define LEX_LESS		 '<'	// проверка на меньше
#define GREATER_EQUAL    '^' // Оператор больше или равно
#define LESS_EQUAL       '~'      // Оператор меньше или равно
