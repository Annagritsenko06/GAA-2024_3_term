...
namespace GRB	// грамматика Грейбах
{
	Greibach greibach(NS('S'), TS('$'), 15,
		...
		Rule(NS('S'), GRB_ERROR_SERIES, 3,						// Неверная структура программы	
			...
			Rule::Chain(5, TS('p'), TS('f'), TS('i'), NS('P'), NS('S')),
			Rule::Chain(5, TS('m'), TS('{'), NS('K'), TS('}'), TS(';'))
		),

		Rule(NS('T'), GRB_ERROR_SERIES + 2, 2,					// Ошибка в теле функции
			Rule::Chain(6, TS('{'), TS('e'), NS('V'), TS(';'), TS('}'),TS(';')),
			Rule::Chain(7, TS('{'), NS('K'), TS('e'), NS('V'), TS(';'), TS('}'),TS(';'))
		),
		...
		Rule(NS('L'), GRB_ERROR_SERIES + 10, 7,					// Неверный условный оператор		
			Rule::Chain(1, TS('<')),
			Rule::Chain(1, TS('>')),
			Rule::Chain(1, TS('&')),
			Rule::Chain(1, TS('!')),
		...
		Rule(NS('W'), GRB_ERROR_SERIES + 13, 10,					// Ошибка в арифметическом выражении
			Rule::Chain(1, TS('i')),
			Rule::Chain(1, TS('l')),
		...
		Rule(NS('K'), GRB_ERROR_SERIES + 14, 16,				// Недопустимая синтаксическая конструкция
			Rule::Chain(7, TS('g'), TS('t'), TS('i'), TS('='), NS('V'), TS(';'), NS('K')),	// декларация + присваивание
			Rule::Chain(5, TS('g'), TS('t'), TS('i'), TS(';'), NS('K')),	// декларация
			Rule::Chain(5, TS('i'), TS('='), NS('W'), TS(';'), NS('K')),	// присваивание
			/*Rule::Chain(4, TS('o'), NS('f'), TS(';'), NS('K')),*/
			Rule::Chain(5, TS('o'), TS('i'), NS('F'), TS(';'), NS('K')),
			...
			Rule::Chain(4, TS('e'), NS('V'), TS(';'), NS('K')),

			Rule::Chain(6, TS('g'), TS('t'), TS('i'), TS('='), NS('V'), TS(';')),	// декларация + присваивание
			Rule::Chain(4, TS('i'), TS('='), NS('W'), TS(';')),			// присваивание
			Rule::Chain(4, TS('g'), TS('t'), TS('i'), TS(';')),			// декларация
			...
			Rule::Chain(4, TS('o'), TS('i'), NS('F'), TS(';'))
		),

		Rule(NS('X'), GRB_ERROR_SERIES + 15, 12,		
		Rule::Chain(7, TS('g'), TS('t'), TS('i'), TS('='), NS('V'), TS(';'), NS('K')),	// декларация + присваивание
		Rule::Chain(5, TS('g'), TS('t'), TS('i'), TS(';'), NS('K')),	// декларация
		Rule::Chain(5, TS('i'), TS('='), NS('W'), TS(';'), NS('K')),	// присваивание		// Недопустимая синтаксическая конструкция в теле цикла/условного выражения	
